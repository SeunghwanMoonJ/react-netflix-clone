...
function TopRatedMovies() {
  ...
  const bigMovieMatch = useRouteMatch<{ movieId: string }>("/trmovie/:movieId");
  const bigMovieMatchOverview = useRouteMatch<{ movieId: string }>(
    "/trmovie/:movieId/overview"
  );
  ...
  const onBigBoxOverviewButtonClicked = (movieId: string) => {
    setBigBoxOverviewClicked((prev) => !prev);
    history.push(`/trmovie/${movieId}/overview`);
  };
        ...
        {bigMovieMatchOverview ? (
          <>
            ...
            <BigBox
              ...
              transition={{ type: "tween", duration: 0.3 }}
              layoutId={bigMovieMatchOverview.params.movieId}
            >
              {clickedMovie ? (
                <>
                  <BigBoxCover
